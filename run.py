...
for sec in sectors:
    if count > 0:
        main(sec,True,0,True,False)
    else:
        main(sec,True,0,True,flag_for_running_stewi)
    count = count + 1
    

sectors = ['ethanol','pulp']
'''
...
for sec in sectors:
    if sec == "ethanol":
        main(sec,False,325193,True,False)
        pass
    elif sec == "pulp":
        main(sec,False,322110,True,False)
